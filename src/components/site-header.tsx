  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-brand-space/85 backdrop-blur-2xl shadow-teal-sm"
          : "bg-brand-space/70 backdrop-blur-xl"
      }`}
    >
            ...
            return (
              <Link
                ...
                className={`text-label-sm uppercase tracking-[0.22em] transition-colors ${
                  active ? "text-brand-teal" : "text-white/60 hover:text-white"
                }`}
              >
                {item.label}
              </Link>
      ...
      {menuOpen ? (
        <div className="border-t border-white/8 bg-brand-space px-6 py-5 md:hidden">
              ...
              return (
                <Link
                  ...
                  className={`text-sm uppercase tracking-[0.22em] ${
                    active ? "text-brand-teal" : "text-white/65"
                  }`}
